 ...
 */
export function evaluateExpression(expression: string, values: Record<string, boolean>): boolean {
	try {
 ...
 */
export function areExpressionsLogicallyEquivalent(expr1: string, expr2: string): boolean {
	try {
